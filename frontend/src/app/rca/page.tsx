 ...
 * Phase 3 of the IndustrialGPT vision.
 *
      ...
      <div className="bg-[#141414] border border-[#252525] rounded-2xl p-5 mb-6">
        <div className="flex gap-3 mb-3">
          <div className="flex-1">
            <label className="text-xs font-semibold text-[#6b7280] block mb-1.5">Symptom / Event Description</label>
            <textarea
              value={symptom}
          ...
          <div className="w-36">
            <label className="text-xs font-semibold text-[#6b7280] block mb-1.5">Equipment (optional)</label>
            <input
              value={equipmentId}
