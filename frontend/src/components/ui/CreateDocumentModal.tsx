 ...
 *
 * Three-step flow:
 *  1. Choose document type (4 types).
  ...
  return (
    ...
    >
      <div
        ...
        tabIndex={-1}
        className="w-full max-w-2xl max-h-[90vh] flex flex-col bg-[#141414] border border-[#2a2a2a] rounded-2xl shadow-2xl overflow-hidden focus:outline-none"
      >
        ...
        <div className="flex items-center gap-3 px-5 py-4 border-b border-[#2a2a2a] flex-shrink-0">
          ...
          <div className="flex-1 min-w-0">
            <h2 id="create-document-modal-title" className="text-sm font-semibold text-[#f9f9f9]">
          ...
          <button
            ...
            className="p-1 rounded-lg hover:bg-[#2a2a2a] text-[#6b7280] hover:text-[#f9f9f9] transition-colors flex-shrink-0"
          >
            <X size={16} />
          </button>
        </div>
          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                aria-label="Context and Description"
                placeholder={
